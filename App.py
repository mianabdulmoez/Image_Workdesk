...
st.set_page_config(
    ...
    menu_items={
        ...
        f"\nApp contact: [Abdul Moeez](moezsaab@gmail.com)",
        "Report a Bug": "https://github.com/mianabdulmoez",
        "Get help": None,
    },
    layout="wide",
)
...
with st.sidebar:
    st.subheader("Developed by Abdul Moeez")
    #  copyright notice
    st.write("© 2023 Abdul Moeez. All rights reserved.")
    # Email
    st.markdown("[Email](moezsaab@gmail.com)")
    # Github Profile 
